...
<body>
      ...
      <form class="col s12" method="POST">
        <div class="row">
          ...
          <div class="input-field col s6">
            ...
            <input id="icon_telephone" type="text" name="cpf" data-mask="000.000.000-00" class="validate">
        ...
        <div class="row">
          <div class="input-field col s6">
            ...
            <input id="icon_telephone" type="tel" name="telefone" data-mask="(00) 00000-0000" class="validate">
        ...
        <div class="row">
          <div class="input-field col s4">
            ...
            <input id="icon_telephone" type="text" name="origem" class="validate">
            <label for="icon_telephone">Origem</label>
          </div>
          <div class="input-field col s4">
            <i class="material-icons prefix">flight_takeoff</i>
            <input id="icon_telephone" type="text" name="destino" class="validate">
            <label for="icon_telephone">Destino</label>
          </div>
          <div class="input-field col s4">
            <i class="material-icons prefix">confirmation_number</i>
            <input id="icon_telephone" type="text" name="voo" class="validate">
        ...
        <div class="row">
          <div class="input-field col s6">
            ...
            <input id="icon_telephone" type="text" name="data_ida" data-mask="00/00/0000" class="validate">
            <label for="icon_telephone">Data ida</label>
          </div>
          <div class="input-field col s6">
            <i class="material-icons prefix">event_note</i>
            <input id="icon_telephone" type="text" name="data_volta" data-mask="00/00/0000" class="validate">
  ...
  <script type="text/javascript" src="<?php echo URL; ?>/assets/js/success.js"></script>
